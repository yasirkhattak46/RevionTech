...
import styles from './UxUiDesignBanner.module.scss';

const HeroBanner = ({ data }) => {
    // Default data if not provided
    const bannerData = data || {
        title: "Creative UI/UX & Graphic Design",
        subtitle: "Beautiful, Intuitive, and User-Centered Design Solutions",
        description: "Transform your brand with stunning visual designs.",
