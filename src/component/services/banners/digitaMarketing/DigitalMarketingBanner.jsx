...
const DigitalMarketingBanner = ({ data }) => {
    // Default data if not provided
    const bannerData = data || {
        title: "Digital Marketing & SEO Solutions",
        subtitle: "Boost Your Online Visibility and Drive Results",
        description: "Comprehensive digital marketing strategies to increase your brand awareness, drive traffic, and convert visitors into customers.",
